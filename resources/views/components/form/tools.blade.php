...
--}}<ul class="dropdown-menu dropdown-menu-right">{{--
    --}}@foreach ($tools as $name => $address)<li><a href="{{ $address }}" @if($name=='delete')onclick="return actionModal(this)" data-method="get" data-size="modal-sm" @endif>{{ trans('common.' . $name) }}</a></li>@endforeach{{--
--}}</ul></div>